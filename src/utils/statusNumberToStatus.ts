...
import {ZoneAdditionalStatus} from 'src/entities/models/Machine';

const statusNumberToStatus = (cycleMode: number): ZoneAdditionalStatus => {
    const cycleIsActive =
